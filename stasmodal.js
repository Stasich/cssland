...
jQuery(document).ready(function () {
    ...
    jQuery('.btnstas2').click(function () {
        jQuery('#overlay_stas').fadeIn(400,
            function () {
                jQuery('#modal_stas')
                    .css('display', 'block')
    ...
    jQuery("<div id='modal_stas'> " +
        ...
        "<form id='stas_modal_form' class='form-horizontal' method='post' action='javascript:void(0)'>" +
            ...
            "<div class='form-groups_stasmodal'>" +
                ...
                "<div><textarea id='textarea_stasmodal' class='' name='mess' rows='3' required='' placeholder='Какой товар вас интересует?*'></textarea></div>" +
            "</div>" +
            "<div class='form-groups_stasmodal'>" +
    ...
    jQuery('#stas_modal_form').submit(function () {
        jQuery.post('/promo/mail.php', {
            ...
            .done(function() {
                ...
                jQuery('#name_stasmodal, #email_stasmodal, #textarea_stasmodal').val('');
            })
            .fail(function(){
                alert ("Что-то пошло не так. Повторите пожалуйста отправку сообщения или напишите свою заявку нам на почту: info@estudo.ru");
            });
    });
    jQuery('#stas_modal_form2').submit(function () {
        jQuery.post('/promo/mail.php', {
            name: jQuery('#name_stasmodal2').val(),
            email: jQuery('#email_stasmodal2').val(),
            mess: jQuery('#textarea_stasmodal2').val()
        })
            .done(function() {
                jQuery('#overlay_stas').fadeIn(400,
                    function () {
                ...
                jQuery('#name_stasmodal2, #email_stasmodal2, #textarea_stasmodal2').val('');
            })
            .fail(function(){
                alert ("Что-то пошло не так. Повторите пожалуйста отправку сообщения или напишите свою заявку нам на почту: info@estudo.ru");
            });
